...
class MainWindow:
    ...
    def notify_work_end(self):
        ...
        self.button_rest.config(command=self.controller.start_rest)  # Add this line
    ...
    def notify_rest_end(self):
        ...
        self.button_work.config(command=self.controller.start_work)  # Add this line
    ...
    def update_ui(self):
        session_count = self.controller.get_session_count()
        print(f"update_ui呼び出し→セッションカウント数{session_count}")
